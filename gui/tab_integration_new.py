...
class TabIntegrator:
    ...
    def integrate_frame(self, frame, frame_name: Optional[str] = None) -> bool:
        ...
        try:
            ...
            # Add event handlers
            if hasattr(self, '_integrate_frame'):
                ...
                self.logger.error("Missing _integrate_frame method")
                return False
        except Exception as e:
